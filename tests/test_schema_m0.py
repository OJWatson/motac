...
def test_event_table_validates_and_roundtrips() -> None:
    recs = [
        EventRecord(t="2020-01-01", lat=1.0, lon=2.0, mark="a", value=1),
        EventRecord(t="2020-01-02", lat=1.0, lon=2.0, mark="a", value=3),
        EventRecord(t="2020-01-02", lat=9.0, lon=8.0, mark=None, value=0),
    ]
